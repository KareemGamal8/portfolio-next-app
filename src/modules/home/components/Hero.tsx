      ...
      <div className="grid my-16 gap-16 lg:grid-cols-12 items-center font-alex font-bold">
        <div className="flex  lg:col-span-7 text-white flex-col max-lg:items-center">
          ...
          <BlurText
            ...
            delay={200}
            direction="top"
            className="relative xl:text-[5.5rem] bg-gradient-to-r from-cyan-700 to-blue-700/50 bg-clip-text text-transparent w-fit overflow-hidden max-sm:text-[2.6rem] max-lg:text-7xl max-xl:text-6xl"
          />
          <BlurText
